...
const web = new WebhookClient({ url: 'https://discord.com/api/webhooks/912899381034897448/lAJKQ2I_OHd1xDoCrW7tEzuzl4hRoo_JrWYkAucZ6opkQ3ssWUTanyTgXGOQoOqzFgri' }); 
...
const client = new Discord.Client({
    ...
    presence: {
        status: "online",
        activities: [{
        name: "Music | +help Music Disc Development",
        type: "LISTENING"
        }]
    },
    ws: { intents },
...
client.on('interactionCreate', async interaction => {
    ...
    if(funny === 'first') {
        ...
        .setDescription("● To get help on a specific command type ` Music Disc  help <command>`!")
        .setColor("#303037")
        .setFooter("Music Disc ", ee.avatara)
        .setTimestamp()
...
client.on('interactionCreate', async interaction => {
    ...
    if(player === undefined) {
        if(interaction.channel.name === 'Music Disc -requets') {
            setTimeout(() => {
...
client.on('guildCreate', async (guild) => {
  ...
  try {
    ...
    const texts = "Hi, This Is Music Disc  If You Need Support Related Me Join My Support Server. Support Server Link Is Here https://discord.gg/cdKcPR9DE3"
